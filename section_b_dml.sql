...
--inserting data to the students table
...
--inserting data to exam results table 
...
--Esther Akinyi moved from Nakuru to Nairobi(student id is 5)
update students
set city = 'Nairobi'
where student_id = 5;

--marks for result id 5
update exam_results
set marks = 59
where result_id = 5;

--deleting exam results for result_id 9
